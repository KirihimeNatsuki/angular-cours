...
import { faPhoneAlt, faEnvelope, faChevronRight, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule { 
    ...
    library.addIcons(faPhoneAlt, faEnvelope, farEnvelope, faFacebookF, faGithub, faLinkedinIn, faChevronRight, faMapMarkerAlt);
  }
}
